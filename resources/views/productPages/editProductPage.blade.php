...
<section class="productPage productPage--edit">
    <div class="container">
        ...
        <form action="{{ route('product.update', ['locale' => app()->getLocale(), 'product' => $product]) }}" method="POST" enctype="multipart/form-data"
            ...
            <h1 class="productPage_title mb-5">{{ __('product.form.edit_title') }}</h1>
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="number" name="volume_ml" id="volume_ml" value="{{ old('volume_ml', $product->volume_ml) }}" min="1" max="10000"
            ...
            <div class="col-12 col-md-4">
                ...
                <input type="number" name="alcohol_percentage" id="alcohol_percentage"
                    value="{{ old('alcohol_percentage', $product->alcohol_percentage) }}" step="0.01" min="0" max="100"
                    class="form-control @error('alcohol_percentage') ring-red @enderror" required>
